...
[length(AllLines), length(TargLines),length(FirstTargLines), length(LastTargLines),...
    length(OtherTargLines), length(Out2InPlot),length(SearchLines), length(PostTargLines)...
    length(BetweenTLines), length(AbsLines)] 
