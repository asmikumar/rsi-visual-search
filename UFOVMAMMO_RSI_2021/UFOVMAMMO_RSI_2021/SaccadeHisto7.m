...
for ThisObsClass=0 % =[1,3] doe experts v residents
    ...
    col(10,:)=hsv2rgb([.1 .8/ThisObsDiv .4]); % other
    ...
    title(tstr,'Color',[0 .5 .7],'FontSize',24);
    xlabel('Saccade length (deg)','Color',[0 0 0],'FontSize',28);
    ylabel('Proportion of saccades','Color',[0 0 0],'FontSize',28);
    %         text(5.3, .30,'All saccades','Color',[0 0 0],'FontSize',28);
    text(5.3, .20,'Search (before targeting)','Color',col(4,:),'FontSize',28);
    %         text(5.3, .26,'Targeting','Color',col(1,:),'FontSize',28);
    %         text(6.5, .24,'First to Target','Color',col(8,:),'FontSize',20);
    %         text(6.5, .20,'Last to Target','Color',col(9,:),'FontSize',20);
    %         text(6.5, .18,'Other Sac to Target','Color',col(10,:),'FontSize',20);
    %         text(6.5, .22,'Between first and last','Color',col(11,:),'FontSize',20);
    text(5.3, .18,'Search (between first and last)','Color',col(6,:),'FontSize',28);
    ...
    figure(101)
    %         plot(0:10,AllSacNorm,liner, 'color', [0 0 0], 'LineWidth',6)
    %         plot(0:10,TargSacNorm,liner, 'color', col(1,:), 'LineWidth',6)
    ...
    %         plot(0:10,FirstTargSacNorm,'-', 'color', col(8,:), 'LineWidth',4,'MarkerFaceColor','g',...
    %             'MarkerSize',16,'MarkerEdgeColor','k')
    %         plot(0:10,LastTargSacNorm,'-', 'color', col(9,:), 'LineWidth',4,'MarkerFaceColor','g',...
    %             'MarkerSize',16,'MarkerEdgeColor','k')
    %         plot(0:10,OtherTargSacNorm,'-', 'color', col(10,:), 'LineWidth',4,'MarkerFaceColor','y',...
    %             'MarkerSize',16,'MarkerEdgeColor','k')
    %         plot(0:10,Out2InSacNorm,'-', 'color', col(11,:), 'LineWidth',4,'MarkerFaceColor','g',...
    %             'MarkerSize',16,'MarkerEdgeColor','k')
    if correctFlag==2
    ...
    for zz=1:3
        ...
        if correctFlag==1 % then use just the correct
            'Filtering for hits'
            SearchTr=intersect(SearchTr,HITtr);
            BetweenTr=intersect(BetweenTr,HITtr);
            PostTr=intersect(PostTr,HITtr);
        elseif correctFlag == 2 % all the incorrect trials
            SearchTr=intersect(SearchTr,INCORRECTtr);
            BetweenTr=intersect(BetweenTr,INCORRECTtr);
            PostTr=intersect(PostTr,INCORRECTtr);
        end
        ...
        for i=1:10 % lower bound of the distance range
            ...
            if correctFlag==1 % then use just the correct
                allDtr=intersect(allDtr,HITtr);
            elseif correctFlag == 2 % all the incorrect trials
                allDtr=intersect(allDtr,INCORRECTtr);;
            end
        ...
        ppostGoToTarg
        figure(102)
        plot(botrange+.25,pGoToTarg(1,:),'-', 'color', hsv2rgb([.33  zz/3  zz/3]), 'LineWidth',zz*2)
        drawnow
        hold on
        plot(botrange+.25,pSearchGoToTarg(1,:),'-', 'color', hsv2rgb([.8  zz/3  zz/3]), 'LineWidth',zz*2)
        drawnow
        hold on
        plot(botrange+.25,pbetweenGoToTarg(1,:),'-', 'color', hsv2rgb([.7  zz/3  zz/3]), 'LineWidth',zz*2)
        drawnow
        hold on
        ...
        figure(104)
        plot(botrange+.25,(ppGoToTarg),'-', 'color',  hsv2rgb([.33  zz/3  zz/3]), 'LineWidth',zz*2)
        drawnow
        hold on
        plot(botrange+.25,(ppSearchGoToTarg),'-', 'color',  hsv2rgb([.8  zz/3  zz/3]), 'LineWidth',zz*2)
        drawnow
        hold on
        plot(botrange+.25,(ppbetweenGoToTarg),'-', 'color',  hsv2rgb([.7  zz/3  zz/3]), 'LineWidth',zz*2)
        drawnow
        hold on
        %         plot(botrange+.25,ppostGoToTarg,'-', 'color', col(2,:), 'LineWidth',6)
