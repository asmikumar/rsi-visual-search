...
% clear all
% close all
plotFlag=0; % 0 = fastest for numbers, 1=normal figures, 2=stop after each obs, 3=add numbers and other diagnostics
saveFlag=0; % 1 = dump every scan path image to disk
...
% First do a tabulation check and correct the TrialType
    ...
    for tr=1:ntrials
        ...
        if isempty(trlines)
            ...
            if plotFlag > 0
                ...
                ttype=UFOVmammo.TrialType(min(trlines)); % cell that contains HIT, MISS, ETC
            ...
            allTlines=find(InBox(trlines)==1);
